...
The CPU usage of each broker is checked at the {pulsar-short} load balancer, not just at the Kubernetes pod level.
...
== Install {product-short} with broker autoscaler enabled

...
To generate a token for a given subject, login to the bastion pod and perform Pulsar Admin operations since the bastion pod already mounts the super user token:

= JWT authentication
:page-aliases: authentication:index.adoc

Authentication in {product-short} is controlled with https://jwt.io/[JWT tokens] for cluster access, and with xref:authentication:auth-tls.adoc[TLS] for communication between applications within the cluster.
...
type: Opaque
data:
  my-private.key: **BASE64_ENCODED_PRIVATE_KEY**
----
...
type: Opaque
data:
  my-public.key: **BASE64_ENCODED_PUBLIC_KEY**
----

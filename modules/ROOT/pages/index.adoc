...
* xref:getting-started:operator.adoc[{pulsar-short} Operator] - Installs just the operator and PulsarCluster CRDs into an existing {pulsar-short} cluster.

* xref:getting-started:stack.adoc[{pulsar-short} Stack] - Installs and deploys the operator, a {pulsar-short} cluster, and a full Prometheus monitoring stack.

...
== CRD requirement for KAAP v0.2.0

If you're upgrading from KAAP v0.1.0 to v0.2.0, you must upgrade the custom resource definition (CRD) version to `v1beta1`.
...
To upgrade the CRDs, run the following command:

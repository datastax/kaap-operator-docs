...
KAAP 0.2.0 is a major release that includes a new version of the CRDs.
This means that you must migrate your existing v0.1.0 CRDs to v0.2.0 CRDs.

[IMPORTANT]
====
The CRDs specs are fully compatible, but you _must_ change the existing custom resource definition version to `v1beta1` during the upgrade.
====

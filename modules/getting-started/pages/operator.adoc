...
You can install just the operator and the `PulsarCluster` custom resource definition (CRD), or you can install xref:getting-started:stack.adoc[{pulsar-stack}], which includes the operator, CRD, and the Prometheus monitoring stack.
